---
name: entire-search
description: Search Entire checkpoint history and transcripts with `entire search --json`. Use proactively when the user asks about previous work, commits, sessions, prompts, or historical context in this repository. Trigger also on Chinese requests such as 查历史会话, 之前的会话讨论了什么, 搜索prompt, 查之前的决策原因, entire search, 历史checkpoint.
---
